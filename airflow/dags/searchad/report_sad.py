...
with DAG(
    ...
    def dbt_postgres_searchad_report_sad_group() -> DbtTaskGroup:
        from dbt_cosmos import dynamic_mapping_dbt_postgres
        return dynamic_mapping_dbt_postgres(
            group_id = "dbt_postgres_searchad_report_sad",
            selector = "searchad_report_sad",
            ds_task_id = "generate_dbt_date_range",
        )
    ...
    dbt_run = [dbt_bigquery_searchad_report_sad_group(), dbt_postgres_searchad_report_sad_group()]
