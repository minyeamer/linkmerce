...
with DAG(
    ...
    def dbt_postgres_cj_loisparcel_invoice_group() -> DbtTaskGroup:
        from dbt_cosmos import dynamic_mapping_dbt_postgres
        return dynamic_mapping_dbt_postgres(
            group_id = "dbt_postgres_cj_loisparcel_invoice",
            selector = "cj_loisparcel_invoice",
            ds_task_id = "generate_dbt_date_range",
        )
    ...
    dbt_run = [dbt_bigquery_cj_loisparcel_invoice_group(), dbt_postgres_cj_loisparcel_invoice_group()]
